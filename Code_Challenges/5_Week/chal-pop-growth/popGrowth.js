 ...
 * 
 * At the end of the 2nd year there will be: 1070 + 1070 * 0.02 + 50 => 1141 inhabitants (** number of inhabitants 
 * is an integer **)
 * 
...
function nbYear (p0, prcnt, aug, p) {
    let countYear= 0;
    while ( p >= p0 ){ 
        countYear++;
        p0 = p0 + (Math.floor(p0 * prcnt / 100)) + aug ;
    }
    return countYear;
}
