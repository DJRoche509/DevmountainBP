...
// CODE HERE
let total = [netflix,hulu,disneyPlus,youtubePremium,peacock].reduce((a,b)=> a + b);
console.log(total) ;
// Alternatively ----> console.log(netflix+hulu+disneyPlus+youtubePremium+peacock)
...
// CODE HERE
var newTotal = netflix + hulu + peacock + disneyPlus + youtubePremium
...
/*
    ...
    and our new total was 85, then we would be saving 
    15%. 
*/

// CODE HERE
let savings;  // the percent value that you're saving
savings = ((total - newTotal) * 100) / total
console.log(`Your percent value in savings is ${savings.toFixed(2)}% !!! `)
