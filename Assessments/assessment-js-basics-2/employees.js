...
//CODE HERE
const empTwo = {...empOne} ;        // copy empOne object into empTwo
empTwo.name = 'Nick' ;              // Set new name for empTwo
console.log(empTwo);      // log out the values of empTwo object
